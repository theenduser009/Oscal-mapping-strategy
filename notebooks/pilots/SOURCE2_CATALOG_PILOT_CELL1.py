...
# Source 2 / Authoritative Sources Source -> Catalog Metadata pilot.
# This is a PREVIEW-only Cell 1 configuration for the existing shared Cells 2-7.
# It does not replace the maintained generic Cell 1 in notebooks/cells/.
...
SOURCE_FILES = [{
    ...
    "MAPPING_FILE": "SOURCE2_CATALOG_PILOT_RUNTIME.csv",
